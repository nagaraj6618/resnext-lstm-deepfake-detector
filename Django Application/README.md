...
You can find the list of requirements in [requirements.txt](https://github.com/nagaraj6618/resnext-lstm-deepfake-detector/blob/main/Django%20Application/requirements.txt). Main requirements are listed below:
...
1. Copy your trained model to the models folder.
   - You can download our trained models from the [Google Drive](https://drive.google.com/drive/folders/1UxVFfENT6LK6tFi45q_NhVE5d7yqQT6l?usp=drive_link) or you can train your models using the steps mentioned in Model Creation directory.

#### Step 1 : Clone the repo and Navigate to Django Application

`https://github.com/nagaraj6618/resnext-lstm-deepfake-detector`
